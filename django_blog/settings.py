...
SECRET_KEY = '$5+vref^pn8x7uqjc%mcxg@_vf@1-^fc^@#fc88145d0%(tk#*'
...
STATIC_DIR = os.path.join(BASE_DIR, "live-static", "static-root")

MEDIA_URL = '/media/'

MEDIA_ROOT = os.path.join(BASE_DIR, "live-media-files", "media-root")